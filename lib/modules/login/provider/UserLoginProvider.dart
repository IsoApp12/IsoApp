                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ConditionalBuilder(
                              ...
                              builder:( context)=> LoginRegisterButton(formKey:formKey, Text: Text('Login',style: TextStyle(fontFamily: 'Courgette',fontSize: 18,color:ColorsManager.defaultColorGreen)),function: () {
                                if (formKey.currentState!.validate()) {
                                  ServicesCubit.get(context).socialLogin(email:EmailController.text ,password:PassowrdController.text );
                                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>HomeScreenProvider()));
                                }
                              } ) ,
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                IconButton(onPressed: (){}, icon: Icon(facebook,color:ColorsManager. defaultColorYellow,),),
